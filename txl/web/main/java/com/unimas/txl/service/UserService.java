...
public class UserService {
	...
	public void deleteAccount(Connection conn, String userNo) throws Exception{
		int id = getIdByUserno(conn, userNo);
		Account acc = new Account();
		acc.setId(id);
		new JdbcDao<Account>().delete(conn, acc);
	}
	...
	private int getIdByUserno(Connection conn, String userNo) throws Exception{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			String sql = "select id from account where user_no=?";
			stmt = conn.prepareStatement(sql);
	...
	public void updatePwd(String userNo, String password) throws Exception{
		Connection conn = null;
		try {
			conn = DBFactory.getConn();
			int id = getIdByUserno(conn, userNo);
	...
	public boolean checkUsername(Connection conn, String username) throws Exception{
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
