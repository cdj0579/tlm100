...
<div class="portlet light ">
    ...
    <div class="portlet-body">
		...
		<table class="table table-striped table-hover table-checkable order-column" id="xx_table"></table>
    </div>
</div>
<script src="${page.basePath }assets/common/require.js" data-main="${page.basePath }assets/xxgl/main" type="text/javascript"></script>