	    ...
	    private static void fromBean(Object bean) {                           
	        ...
	        try {                                                             
	            ...
	            for (int i = 0; i < props.length; i++) {                      
	                ...
	                String typeDesc = pdesc.getPropertyType().toString();
	                ...
	                if(typeDesc.indexOf("[B")!=-1){//byte[]数组("class [B")){
	                	byte[] bits = (byte[])pvalue;
	                	pvalue = new String(bits,"utf-8");
	                }
	        ...
	        String endStr = builder.substring(builder.length()-1, builder.length());
	        if(endStr.equals(",")){
