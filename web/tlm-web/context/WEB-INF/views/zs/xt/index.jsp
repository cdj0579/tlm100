...
<div class="portlet light">
	...
	<div class="portlet-body">
		<div class="row">
       	...
       	<table id="xt_table" class="table table-striped table-hover"></table>
	</div>
</div>
<script src="${page.basePath }assets/common/require.js" data-main="${page.basePath }assets/zs/xt/js/main" type="text/javascript"></script>